            ...
            if(id !== null){
                ...
                if(result === 'true'){
                    if(data.data.file_upload === 'N'){
                        ...
                        // dispatch(updateUserInfo({"file_check": [], "file_upload": "Y", "location": "영흥", "mt_idx": "100", "mt_name": "name", "mt_type": "1"})); // 건설업자 로그인
                        dispatch(updateUserInfo({"file_check": [], "file_upload": "Y", "location": "영흥", "mt_idx": "101", "mt_name": "name", "mt_type": "2"})); // 장비업체 로그인
